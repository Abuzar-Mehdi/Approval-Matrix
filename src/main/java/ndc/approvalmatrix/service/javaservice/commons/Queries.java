...
public class Queries {
    ...
    public static class CAM_QUERY {
        ...
        public static final String CAM_QUERY3 = "INSERT INTO ndc_am_matrix_detail\" +\n" +
                "matrixid, workflowid, sequenceno, groupno, role, ischecker, rulevalue, rule,approvalorder)\" +\n" +
                "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";

        public static final String CAM_QUERY4 = "INSERT INTO ndc_am_workflow \" +\n" +
    ...
    public static class CNR_QUERIES {
        ...
        public static final String CNR_QUERY1 = "INSERT INTO ndc_am_request\" +\n" +
    ...
    public static class AR_QUERIES {
       ...
       // public static final String AR_QUERY7 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE ID=?";
       // public static final String AR_QUERY8 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?   WHERE ID=?";
       // public static final String AR_QUERY9 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE ID=?";
        //public static final String AR_QUERY10 = "UPDATE ndc_am_instances SET  GROUPSTATUS=? WHERE REQUESTID=? AND SEQUENCENO=? AND  GROUPNO=? ";
       // public static final String AR_QUERY11 = "UPDATE ndc_am_instances SET  SEQSTATUS=? WHERE REQUESTID=? AND SEQUENCENO=? ";
       // public static final String AR_QUERY12 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?   WHERE ID=?";
       ...
       // public static final String AR_QUERY14 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE ID=?";
       // public static final String AR_QUERY15 = "UPDATE ndc_am_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE ID=?";
    ...
    public static class RR_QUERIES {
        ...
        public static final String RR_QUERY1 = "SELECT NR.ID,NR.CONTRACTID ,NR2.SEQUENCENO,NR2.ID AS REQID,NR2.RULEVALUE,NR.STATUS ,NR2.SEQSTATUS,NR2.STATUS as APPROVERSTATUS,NR2.GROUPSTATUS,NR.ISSEQUENTIAL FROM ndc_request NR  " +
                "INNER JOIN ndc_requestworkflow NR2 ON NR.ID =NR2.REQUESTID " +
                "WHERE NR.CONTRACTID =? AND  NR.ACCOUNTNO=?  AND NR2.APPROVERID =? AND NR.REFERENCENO =?";
        public static final String RR_QUERY2 = "UPDATE ndc_requestworkflow SET  STATUS=?,GROUPSTATUS=?,SEQSTATUS=?, REMARKS=? WHERE ID=? ";
        public static final String RR_QUERY3 = "UPDATE ndc_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE ID=?";
    ...
    public static class CR_QUERIES {
        ...
        public static final String CR_QUERY1 = "SELECT * FROM ndc_request WHERE  CONTRACTID=? AND  REFERENCENO=? AND  SOFTDELETE=0 ";
        public static final String CR_QUERY2 = "UPDATE ndc_request SET  STATUS=? , REMARKS=? , MODIFYDATE=? , MODIFYBY=?  WHERE  REQUESTERID=? AND CONTRACTID=? AND REFERENCENO=?";
    ...
    public static class GW_QUERIES {
        ...
        public static final String GW_QUERY3 = "SELECT workflowid,issequential,featureactionid,minamount,maxamount FROM ndc_am_workflow where matrixid=? AND workflowid=? ";
